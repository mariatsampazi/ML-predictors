...
# a) plot some metrics from the csv files
...
#We set the path for saving the combined csv file 
path='/Users/maria/Documents/GitHub/oran_efforts'
...
# and has nothing to do with the preparation of datasers for our Random Forest (RF) Regression Algorithm.
...
os.chdir("/Users/maria/Documents/GitHub/oran_efforts")
...
df2.to_csv('pred_time.csv', index=False,header=False)
